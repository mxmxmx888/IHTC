...
oldPatient.assignedSurgeonId -- s1
hospital.patients -- oldPatient
...
newPatient.assignedSurgeonId -- s1
hospital.patients -- newPatient

oldAdmission: Admission {
    admissionDay = 1
}
oldAdmission.patientId -- oldPatient
oldAdmission.roomId -- r1
oldAdmission.operationTheatreId -- ot1

tracker1: DeletedAdmissionsTracker {
    count = 0
}
hospital.deletedAdmissionsTrackers -- tracker1
