...
match {
    ...
    // a different non-mandatory patient. This acts as a swap move that tests
    // whether replacing one optional patient with another improves the schedule.
    patient: Patient {}
    ...
    // Both the removed and inserted patients must be non-mandatory.
